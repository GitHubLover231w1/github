...
local function prepareforlevel()
	local function clear()
		...
		for i,flood in flood1 do 
			flood:Destroy()
		end
		for i,flood in flood2 do 
			flood:Destroy()
		end
		for i,flood in flood3 do 
			if flood.Name == "Rifle" then
	...
	local function buyrifle()
		local rifle = workspace.BuyableItems.Rifle
