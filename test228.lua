...
local function killdecide(killthink)
	...
	if buddhaarrived == false then
		if npc.Name == "Cupid Queen" or npc.Name == "Love Empress" or npc.Name == "Elo The Bunny" or npc.Name == "Santa" or npc.Name == "Head Jailer of Impel Down" or npc.Name == "Kramprus" or npc.Name == "Blugori" or npc.Name == "Mini Bunny" then
			method = "Boss"
			higher = 350
	...
	elseif game.PlaceId == idimpel then
		...
		local function functionlauncer()
			...
			elseif tablecount == 10 or tablecount == 18 or tablecount == 19 or tablecount == 3 or tablecount == 1 then
				...
				tablecount += 1
				functionlauncer()
			elseif tablecount == 14 or tablecount == 40 then 
